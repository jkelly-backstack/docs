...
When you have no workspaces yet, you'll see a helpful empty state with quick access to create your first workspace:

<img src="/images/workspaces/mobile-empty-state.png" alt="Mobile empty state view with create workspace button" />
