...
<img src="/images/workspaces/desktop-grid.png" alt="Workspaces list view showing multiple workspaces in a grid layout" />

## Creating a Workspace

When you have no workspaces yet, you'll see an empty state with a button to create your first workspace:

<img src="/images/workspaces/mobile-empty-state.png" alt="Empty state view showing no workspaces with create button" />
...
<img src="/images/workspaces/workspace-members-list.png" alt="Workspace members list showing user cards with avatars, names, emails, and role badges" />

The Add Member dialog allows you to invite users by email and assign them a role:

<img src="/images/workspaces/add-member-dialog.png" alt="Add Member dialog with email input and role selector dropdown" />
...
On mobile devices, workspaces display in a single-column layout for easy browsing:

<img src="/images/workspaces/mobile-workspaces.png" alt="Mobile view of workspaces showing single-column layout" />

### Tablet View

On tablets, workspaces display in a two-column grid that balances information density with touch-friendly interface:

<img src="/images/workspaces/tablet-portrait.png" alt="Tablet portrait view showing two-column workspace grid" />
