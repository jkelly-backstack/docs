...
NPM packages are MCP tools that are installed from npm and run automatically when called by your AI clients.
...
<img src="/images/organization-services/add-service-dropdown.png" alt="Add Service dropdown menu" />
...
<img src="/images/organization-services/npm-package-dialog.png" alt="NPM Package installation dialog" />
...
1. Downloads the package and its dependencies
2. Prepares the service for deployment
3. Deploys the service to run automatically when called
4. Makes the service available for assignment to workspaces
...
<img src="/images/organization-services/remote-server-dialog.png" alt="Remote Server connection dialog" />
...
<img src="/images/organization-services/service-status-badges.png" alt="Service status badges in the admin tools interface" />
